            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="sidebar-scroll">
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item">
                            <a class="nav-link {{ (Request::routeIs('admin.admin-dashboard') || 
                                                    Request::routeIs('admin.dashboard-totals.completed-reviews') || 
                                                    Request::routeIs('admin.dashboard-totals.pending-review') || 
                                                    Request::routeIs('admin.dashboard-totals.files-submitted')) ? 'active' : '' }}"
