                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item">
                                            <a href="#!" class="breadcrumb-link" style="cursor: default; color: #3d405c;">Maintenance</a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="{{ route('admin.announcement.admin-announcement') }}" class="breadcrumb-link">Announcement</a>
                                        </li>
                                        <li class="breadcrumb-item">
                                            <a href="{{ route('admin.announcement.add-announcement') }}" class="breadcrumb-link">Add Announcement</a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                            ...
                            <div class="email editor">
                                <div class="col-md-12 pl-4 px-4">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="summernote" id="announcement-editor" name="announcement_message" rows="6" placeholder="Write Descriptions" required></textarea>
                                    </div>
                                </div>
