                        ...
                        <div class="page-header">
                            <div class="col d-flex justify-content-between align-items-center">
                                ...
                                {{-- <div class="ml-auto text-right">
                                    <a href="{{ route('generate.all.reports') }}" class="btn btn-primary">Generate All Reports</a>
                                </div> --}}
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @foreach($semesters as $semester)
                                                <a class="dropdown-item" href="{{ route('generate.all.reports', ['semester' => $semester->semester]) }}">
                                                    {{ $semester->semester }}
                                                </a>
                                            @endforeach
                                        </div>
