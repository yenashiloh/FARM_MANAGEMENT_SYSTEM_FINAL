...
<head>
    ...
    <title>Syllabus Preparation</title>
    <!-- Bootstrap CSS -->
...
<body>
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Syllabus Preparation</h2>
                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0"> Syllabus Preparation (an academic document that communicates
                                   ...
                                   <!-- Filter by Semester Dropdown -->
                                    ...
                                    <div class="col-md-3 mb-3 position-relative">
                                        <select name="folder_name" class="form-control">
                                            ...
                                            @foreach($folders->where('main_folder_name', 'Syllabus Preparation') as $folder)
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body body-modal">
                        ...
                        <form id="uploadForm" action="{{ route('files.store.syllabus') }}" method="POST" enctype="multipart/form-data">
                            @csrf
   ...
   <script>
    $(document).ready(function() {
        ...
        try {
            availableSemesters = JSON.parse('@json($availableSemesters ?? [])');
            availableSchoolYears = JSON.parse('@json($availableSchoolYears ?? [])');
            allSchedules = JSON.parse('@json($courseSchedules ?? [])');
        } catch (e) {
        ...
        function updateAvailableDocuments(semester, schoolYear) {
            ...
            try {
                uploadedFoldersByPeriod = JSON.parse('@json($uploadedFoldersByPeriod ?? [])');
            } catch (e) {
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.addEventListener('click', function(event) {
        ...
        if (button) {
            ...
            const relevantMessages = JSON.parse('@json($messages)').filter(
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const uploadedFoldersByPeriod = JSON.parse('@json($uploadedFoldersByPeriod)');
    const allFolders = JSON.parse('@json($allFolders)');
