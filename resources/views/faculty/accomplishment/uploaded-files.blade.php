...
<body>
    ...
    viewFilesModal.addEventListener('show.bs.modal', function(event) {
        ...
        files.forEach(file => {
            ...
            let archiveButtonHtml = ''; // Initialize archive button HTML

            // Define status badge class and declined reason
            switch (status) {
                case 'Approved':
                    badgeClass = 'bg-success';
                    // Show the archive button only if the file is approved and not archived
                    if (!file.is_archived) {
                        archiveButtonHtml = `
                            <form action="/archive-file/${file.id}" method="POST" style="display:inline;">
                                <button type="submit" class="btn btn-warning btn-sm" style="float:right;">
                                    Archive
                                </button>
                            </form>
                        `;
            ...
            // Insert the HTML content into the list item
            listItem.innerHTML = `
                <div>
