...
class CourseScheduleSeeder extends Seeder
{
    public function run()
    {
        ...
        // Second Sem 2024-2025 courses
        DB::table('course_schedules')->insert([
            [
                'course_schedule_id' => 11,
                'user_login_id' => $userIds[0],
                'sem_academic_year' => 'Second Sem 2024-2025',
                'program' => 'Bachelor of Science in Information Technology (BSIT)',
                'course_code' => 'CS102',
                'course_subjects' => 'Object-Oriented Programming',
                'year_section' => '1-1',
                'schedule' => 'Mon 10:00 - 12:00, Wed 10:00 - 12:00',
            ],
            [
            ...
            [
                ...
                'program' => 'Diploma in Information Communication Technology (DICT)',
                'course_code' => 'DB203',
                'course_subjects' => 'Advanced Database Systems',
                'year_section' => '2-2',
                'schedule' => 'Wed 14:00 - 16:00, Fri 10:00 - 12:00',
            ],
            [
                ...
                'program' => 'Diploma in Information Communication Technology (DICT)',
                'course_code' => 'OS202',
                'course_subjects' => 'Advanced Operating Systems',
                'year_section' => '2-1',
                'schedule' => 'Mon 09:00 - 11:00, Thurs 09:00 - 11:00',
            ],
            [
                ...
                'program' => 'Bachelor of Science in Applied Mathematics (BSAM)',
                'course_code' => 'MGT202',
                'course_subjects' => 'Strategic Management',
                'year_section' => '3-1',
                'schedule' => 'Tues 13:00 - 15:00, Fri 13:00 - 15:00',
            ],
            // Add 5 more entries for the second semester
            [
                ...
                'program' => 'Bachelor of Science in Entrepreneurship (BSENTREP)',
                'course_code' => 'ENT401',
                'course_subjects' => 'Advanced Technopreneurship',
                'year_section' => '1-1',
                'schedule' => 'Mon 09:00 - 11:00, Wed 09:00 - 11:00',
            ],
            [
            ...
            [
                ...
                'program' => 'Bachelor of Science in Applied Mathematics (BSAM)',
                'course_code' => 'MTH303',
                'course_subjects' => 'Advanced Statistics',
                'year_section' => '3-2',
                'schedule' => 'Wed 11:00 - 13:00, Fri 11:00 - 13:00',
            ],
            [
                ...
                'program' => 'Bachelor of Science in Information Technology (BSIT)',
                'course_code' => 'DB302',
                'course_subjects' => 'Advanced Discrete Mathematics',
                'year_section' => '2-2',
                'schedule' => 'Mon 12:00 - 14:00, Thurs 12:00 - 14:00',
            ],
            [
                ...
                'program' => 'Bachelor of Science in Information Technology (BSIT)',
                'course_code' => 'SYS302',
                'course_subjects' => 'Advanced Systems Analysis and Design',
                'year_section' => '3-1',
                'schedule' => 'Tues 14:00 - 16:00, Fri 14:00 - 16:00',
            ],
        ]);
