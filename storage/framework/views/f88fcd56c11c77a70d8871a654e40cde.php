                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form action="<?php echo e(route('updateAccount')); ?>" method="POST" id="basicform" data-parsley-validate="">
                                        <?php echo csrf_field(); ?>
                                        <!-- Success Message -->
...
<?php /**PATH C:\Users\Ed Judah Mingo\Documents\Laravel\FARM_MANAGEMENT_SYSTEM_FINAL-3\resources\views/admin/admin-account.blade.php ENDPATH**/ ?>