                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <?php $__currentLoopData = $semesters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $semester): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <a class="dropdown-item"
                                                href="<?php echo e(route('generate.all.reports.director', ['semester' => $semester->semester])); ?>">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#!" class="breadcrumb-link"
                                                >Menu</a></li>
                                        <li class="breadcrumb-item"><a href="<?php echo e(route('director.director-dashboard')); ?>"
...
<?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/director/director-dashboard.blade.php ENDPATH**/ ?>