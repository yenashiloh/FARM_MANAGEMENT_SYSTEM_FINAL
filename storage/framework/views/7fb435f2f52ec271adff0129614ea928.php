                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Approved Files</h2>
                       ...
                       <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card-header">
                                <h5 class="mb-0">List of All Approved Files</h5>
                            </div>
                            <div class="card-body">
                                        ...
                                        <tbody>
                                              <?php $__currentLoopData = $consolidatedFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                               ...
                                               <td class="text-center">
                                                    <?php echo e($file['files'][0]['status']); ?> | 
                                                    <?php echo e($file['is_archived'] == 0 ? 'Active' : 'Archived'); ?>
...
<?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/faculty/accomplishment/approved-files.blade.php ENDPATH**/ ?>