...
<div class="dashboard-main-wrapper">
    ...
    <div class="dashboard-header">
        <nav class="navbar navbar-expand-lg bg-white fixed-top">
            <a class="navbar-brand" href="<?php echo e(route('admin.admin-dashboard')); ?>">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav flex-column">
                        ...
                        <li class="nav-item ">
                            <a class="nav-link <?php echo e(Request::routeIs('admin.admin-dashboard') ? 'active' : ''); ?>"
...
<?php /**PATH C:\Users\Ed Judah Mingo\Documents\Laravel\FARM_MANAGEMENT_SYSTEM_FINAL-3\resources\views/partials/admin-sidebar.blade.php ENDPATH**/ ?>