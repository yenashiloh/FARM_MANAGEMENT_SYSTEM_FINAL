...
<body>
            ...
            <div class="container-fluid dashboard-content ">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#!" class="breadcrumb-link"
                                                >Menu</a></li>
                                        <li class="breadcrumb-item"><a href="<?php echo e(route('faculty.faculty-dashboard')); ?>"
                ...
                <div class="ecommerce-widget">
                    <div class="row">
                        ...
                        <a href="<?php echo e(route ("faculty.accomplishment.pending-files")); ?>" class="text-decoration-none">
                        ...
                        <!-- Total Approved Card -->
                      <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                        <a href="<?php echo e(route ("faculty.accomplishment.approved-files")); ?>" class="text-decoration-none">
                            <div class="card card-count" style="cursor: pointer; transition: background-color 0.3s;">
                                <div class="card-body">
                                    <div class="d-inline-block">
                        ...
                        <!-- Total Declined Card -->
                       <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-12">
                        <a href="<?php echo e(route ("faculty.accomplishment.declined-files")); ?>" class="text-decoration-none">
                            <div class="card card-count" style="cursor: pointer; transition: background-color 0.3s;">
                                <div class="card-body">
                                    <div class="d-inline-block">
                                        <h5 class="text-muted">Total Declined</h5>
                                        <h2 class="mb-0"><?php echo e($declinedCount); ?></h2>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-inline-block">
                                        ...
                                        <h2 class="mb-0"> <?php echo e($formattedTotalStorageUsed); ?></h2>
                                    </div>
        ...
        <script>
            ...
            function initializeStorageChart() {
                ...
                var storageChart = new Chart(ctx, {
                    ...
                    data: {
                        labels: [
                            'Used Storage (<?php echo e($formattedTotalStorageUsed); ?>)',
                            'Available Storage (<?php echo e($formattedStorageAvailable); ?>)'
                        ],
                        datasets: [{
                            data: [<?php echo e($totalStorageUsed); ?>, <?php echo e($storageAvailable); ?>],
            ...
            function initializeFolderChart() {
                ...
                const folderChartData = <?php echo json_encode($folderChartData, 15, 512) ?>;
                const datasets = [];
   ...
   //announcement pop up
            document.addEventListener('DOMContentLoaded', function() {
                let announcements = <?php echo json_encode($announcements, 15, 512) ?>;
...
<?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/faculty/faculty-dashboard.blade.php ENDPATH**/ ?>