        ...
        <div class="dashboard-ecommerce">
            <div class="container-fluid dashboard-content">
                ...
                <div class="ecommerce-widget">
                    <div class="row">
                        <div class="col-12">
                            <form method="POST" action="<?php echo e(route('admin.announcement.save-announcement')); ?>"
                                id="announcementForm">
                                <?php echo csrf_field(); ?>
                                            ...
                                            <div class="col-md-11">
                                                <select id="recipientEmails" class="js-example-basic-multiple"
                                                    ...
                                                    <optgroup label="Faculty Emails">
                                                        <?php $__currentLoopData = $facultyUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <option value="<?php echo e($user->user_login_id); ?>">
...
<?php /**PATH C:\Users\Ed Judah Mingo\Documents\Laravel\FARM_MANAGEMENT_SYSTEM_FINAL-3\resources\views/admin/announcement/add-announcement.blade.php ENDPATH**/ ?>