    ...
    <div class="dashboard-wrapper">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        <li class="breadcrumb-item"><a href="#!" class="breadcrumb-link"
                                                >Menu</a></li>
                                        <li class="breadcrumb-item"><a href="<?php echo e(route('admin.request-upload-access')); ?>"
                            ...
                            <div class="card-body">
                               ...
                               <div class="table-responsive">
                                    <table id="uploadRequestsTable" class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            <?php $__currentLoopData = $uploadRequests; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $request): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr>
                                                    <td><?php echo e($request->created_at->format('F j, Y')); ?></td>
                                                    <td><?php echo e($request->created_at->format('g:i A')); ?></td>
                                                    <td><?php echo e($request->user->first_name); ?> <?php echo e($request->user->surname); ?></td>
                                                    <td><?php echo e($request->reason); ?></td>
                                                    <td><?php echo e($request->status_request); ?></td>
                                                    <td>
                                                        <form action="<?php echo e(route('admin.approve-upload-request', $request->request_upload_id)); ?>" method="POST">
                                                            <?php echo csrf_field(); ?>
        ...
        $(document).ready(function() {
            ...
            function fetchUploadRequests() {
                $.ajax({
                    url: "<?php echo e(route('real.time.access')); ?>", 
                    method: 'GET',
...
<?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/admin/request-upload-access.blade.php ENDPATH**/ ?>