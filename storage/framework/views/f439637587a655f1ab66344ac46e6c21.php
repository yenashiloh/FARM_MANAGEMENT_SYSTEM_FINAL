                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="page-header">
                            <h2 class="pageheader-title">Pending Review </h2>
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item">
                                            <a href="<?php echo e(route ('admin.dashboard-totals.pending-review')); ?>"
                                                class="breadcrumb-link" style=" color: #3d405c;">Pending Review</a>
                                        </li>
                                    </ol>
                                </nav>
                            </div>
...
<?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/admin/dashboard-totals/pending-review.blade.php ENDPATH**/ ?>