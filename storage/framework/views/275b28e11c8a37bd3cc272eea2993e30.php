        ...
        <div class="row gy-4">
          <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center" data-aos="zoom-out">
            ...
            <!-- Faculty Login with OAuth -->
             <a href="<?php echo e($oauthUrl); ?>" class="btn-get-started">Faculty Login</a>
        
            <!-- Admin Login using Route -->
            <a href="<?php echo e(route('login')); ?>" class="btn-get-started ms-3" style="background-color: #FFDF00; color: black; border: 1px solid #FFDF00;">Admin Login</a>
        </div>
            ...
            <div class="row gy-3">
                ...
                <div class="col-xl-12 col-lg-12" data-aos="fade-up" data-aos-delay="200">
                    <div class="pricing-item featured">
                        <h3 class="subject"><?php echo e($announcement->subject); ?></h3>
                        <div class="message">
    ...
    <div class="container footer-top">
        <div class="row gy-4">
          <div class="col-lg-6 col-md-12 footer-about">
            <a href="<?php echo e(route ('welcome')); ?>" class="d-flex align-items-center">
...
</html><?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/welcome.blade.php ENDPATH**/ ?>