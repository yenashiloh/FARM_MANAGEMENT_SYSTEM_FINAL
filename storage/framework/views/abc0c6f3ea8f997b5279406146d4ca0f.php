    ...
    <div class="dashboard-wrapper">
                            ...
                            <div class="page-breadcrumb">
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a
                                                href="<?php echo e(route('director.accomplishment.view-faculty-accomplishment', [
                                                               ...
                                                               <div class="d-flex justify-content-start">
                                                                    <?php if($file->status === 'To Review'): ?>
                                                                        <a href="javascript:void(0)" 
                                                                            onclick="confirmApproval('<?php echo e(route('approveFileDirector', ['courses_files_id' => $file->courses_files_id])); ?>')"
                                                                    ...
                                                                    <?php elseif($file->status === 'Approved'): ?>
                                                                        <button type="button" class="btn btn-warning btn-sm mb-2 mr-2" onclick="undoApprovalDirector('<?php echo e(route('undoApprovalDirector', ['courses_files_id' => $file->courses_files_id])); ?>')">
                                                                            Undo Approval
                                                                        </button>
                                                                    <?php elseif($file->status === 'Declined'): ?>
                                                                        <button type="button" class="btn btn-warning btn-sm mb-2 mr-2" onclick="undoDeclinedDirector('<?php echo e(route('undoDeclinedDirector', ['courses_files_id' => $file->courses_files_id])); ?>')">
                                                                            Undo Declined
                                                                        </button>
                                                                    <?php endif; ?>
                            ...
                            <div class="modal fade" id="declineModal" tabindex="-1" role="dialog"
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <form id="declineFormDirector" method="POST">
                                            <?php echo csrf_field(); ?>
        ...
        $(document).ready(function() {
            $('button[data-target="#declineModal"]').on('click', function() {
                ...
                var actionUrl = "<?php echo e(route('declineFileDirector', ['courses_files_id' => ':courses_files_id'])); ?>"
                    .replace(':courses_files_id', fileId);
    
                $('#declineModalId').val(fileId);
                $('#declineFormDirector').attr('action', actionUrl);
            });
    
            $('#declineFormDirector').on('submit', function() {
       ...
       function undoDeclinedDirector(undoDeclinedUrl) {
            Swal.fire({
                title: 'Are you sure?',
        ...
        // confirmation Undo
        function undoApprovalDirector(approvalUrl) {
            Swal.fire({
                title: 'Are you sure?',
       ...
       document.addEventListener('DOMContentLoaded', function() {
                    ...
                    button.addEventListener('click', function() {
                        ...
                        messageContainer.innerHTML = `
                            ${relevantMessages.map(msg => {
                                const isDirector = msg.user_login.role === 'director';
                                const alignment = isDirector ? 'justify-content-end' : 'justify-content-start';
                                const style = isDirector ? 'bg-primary text-white' : 'alert alert-secondary';
                                const nameDisplay = !isDirector ? `<div class="font-weight-bold small mb-1">${msg.user_login.first_name} ${msg.user_login.surname}</div>` : '';
            ...
            function setupMessageForm(form) {
                form.addEventListener('submit', function(e) {
                    ...
                    fetch('<?php echo e(route("send.file.message.director")); ?>', {
                        method: 'POST',
                        headers: {
...
<?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/director/accomplishment/view-faculty-accomplishment.blade.php ENDPATH**/ ?>