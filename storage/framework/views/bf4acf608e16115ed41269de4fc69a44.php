                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3 mb-2 position-relative">
                                        <select name="folder_name" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $folders->where('main_folder_name', 'Test Administration'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body body-modal">
                        ...
                        <form id="uploadForm" action="<?php echo e(route('files.store.test-administration')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/faculty/accomplishment/test-administration.blade.php ENDPATH**/ ?>