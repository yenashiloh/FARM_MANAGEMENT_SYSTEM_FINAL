                                   ...
                                   <!-- Filter by Semester Dropdown -->
                                    ...
                                    <div class="col-md-3 mb-3 position-relative">
                                        <select name="folder_name" class="form-control">
                                            ...
                                            <?php $__currentLoopData = $folders->where('main_folder_name', 'Syllabus Preparation'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $folder): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                              ...
                                              <?php $__currentLoopData = $consolidatedFiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <tr class="file-row" data-semester="<?php echo e($file['semester']); ?>" data-school-year="<?php echo e($file['school_year']); ?>">
                                                 ...
                                                 <td class="text-center">
                                                    ...
                                                    <?php if($file['files'][0]['declined_reason']): ?>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body body-modal">
                        ...
                        <form id="uploadForm" action="<?php echo e(route('files.store.syllabus')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/faculty/accomplishment/syllabus-preparation.blade.php ENDPATH**/ ?>