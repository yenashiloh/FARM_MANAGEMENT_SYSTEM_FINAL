                                ...
                                <li>
                                    ...
                                    <div class="list-group" id="notification-items">
                                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            ?>
                                            <a href="<?php echo e($hasCoursesFile ? route(
                                                ...
                                                <div class="notification-info">
                                                    ...
                                                    <div class="notification-list-user-block">
                                                        <span class="notification-list-user-name mr-0"><?php echo e($notification->sender); ?></span>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <div class="sidebar-scroll">
                        <ul class="navbar-nav flex-column">
                           ...
                           <li class="nav-item">
                            <a class="nav-link 
                                <?php echo e(request()->routeIs('faculty.faculty-dashboard') || 
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('faculty.request-upload-access') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('faculty.request-upload-access')); ?>" aria-expanded="false" data-target="#submenu-1" aria-controls="submenu-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('faculty.accomplishment.uploaded-files') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('faculty.accomplishment.uploaded-files')); ?>"
                                    data-target="#submenu-1" aria-controls="submenu-1">
                            ...
                            <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('faculty.accomplishment.test-administration') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('faculty.accomplishment.test-administration')); ?>"
                                    data-target="#submenu-1" aria-controls="submenu-1">
                             ...
                             <li class="nav-item">
                                <a class="nav-link <?php echo e(request()->routeIs('faculty.accomplishment.syllabus-preparation') ? 'active' : ''); ?>"
                                    href="<?php echo e(route('faculty.accomplishment.syllabus-preparation')); ?>"
                                    data-target="#submenu-1" aria-controls="submenu-1">
...
<?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/partials/faculty-sidebar.blade.php ENDPATH**/ ?>