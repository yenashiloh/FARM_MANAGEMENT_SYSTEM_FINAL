                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a
                                                href="<?php echo e(route('admin.submission-tracker')); ?>"
                                    ...
                                    <table class="table table-striped table-bordered first">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo e($user->surname); ?>, <?php echo e($user->first_name); ?></td>
                                                <td>
                                                   <div class="progress">
                                                    <div class="progress-bar bg-warning" role="progressbar" 
                                                        style="width: <?php echo e($progressData[$user->user_login_id]); ?>%;" 
                                                        aria-valuenow="<?php echo e($progressData[$user->user_login_id]); ?>" 
                                                        aria-valuemin="0" 
                                                        aria-valuemax="100">
                                                        <?php echo e(number_format($progressData[$user->user_login_id], 2)); ?>%
                                                    </div>
                                                </div>
                                                </td>
                                                <td>
...
<?php /**PATH /home/u687103837/domains/pupt-farm.com/public_html/resources/views/admin/submission-tracker.blade.php ENDPATH**/ ?>